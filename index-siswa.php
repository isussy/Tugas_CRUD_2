...
<div class="container mt-4">
    <h2>Data Siswa</h2><br>
    <a class="btn btn-primary" href="kelola-siswa.php" role="button">Tambah Data</a>
    <br><br>
...
<tbody>
    ...
    while ($siswa = mysqli_fetch_array($query)){
        ...
        echo "<td>
        <a href='kelola-siswa.php?edit=".$siswa['id_pendaftaran']."' class='btn btn-warning'>Edit</a>
        <a href='proses-siswa.php?hapus=".$siswa['id_pendaftaran']."' class='btn btn-danger'>Delete</a>
</td>";
echo "</tr>";
}
?>
